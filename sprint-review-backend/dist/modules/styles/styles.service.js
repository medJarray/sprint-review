...
let StylesService = class StylesService {
    ...
    async findBySprint(sprintId) {
        ...
        if (!doc)
            throw new common_1.NotFoundException(`Styles introuvables pour le sprint "${sprintId}"`);
        return doc;
    }
    ...
    async remove(sprintId) {
        ...
        if (result.deletedCount === 0)
            throw new common_1.NotFoundException(`Styles introuvables pour "${sprintId}"`);
    }
};
exports.StylesService = StylesService;
exports.StylesService = StylesService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, mongoose_1.InjectModel)(style_schema_1.Style.name)),
