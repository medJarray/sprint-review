...
const metric_schema_1 = require("./schemas/metric.schema");
let MetricsService = class MetricsService {
    ...
    async findBySprint(sprintId) {
        ...
        if (!doc)
            throw new common_1.NotFoundException(`Métriques introuvables pour le sprint "${sprintId}"`);
        return doc;
    }
    ...
    async remove(sprintId) {
        ...
        if (result.deletedCount === 0)
            throw new common_1.NotFoundException(`Métriques introuvables pour "${sprintId}"`);
    }
};
exports.MetricsService = MetricsService;
exports.MetricsService = MetricsService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, mongoose_1.InjectModel)(metric_schema_1.Metric.name)),
